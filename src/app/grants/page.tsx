...
const openGrants = [
  {
    ...
    description:
      "สนับสนุนผู้ประกอบการขนาดกลางและเล็กในการพัฒนาและประยุกต์ใช้เทคโนโลยี AI เพื่อเพิ่มประสิทธิภาพการดำเนินธุรกิจ",
    budget: "2,000,000",
  ...
  },
  {
    ...
    description:
      "สนับสนุนการวิจัยและพัฒนาเครื่องมือวิเคราะห์ข้อมูลขนาดใหญ่ เพื่อสร้างมูลค่าเพิ่มให้กับภาคอุตสาหกรรม",
    budget: "5,000,000",
  ...
  },
  {
    ...
    description:
      "สนับสนุนองค์กรในการปรับเปลี่ยนสู่ดิจิทัล ครอบคลุมทั้งกระบวนการทำงาน ระบบ และบุคลากร",
    budget: "1,500,000",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              ค้นหาทุนสนับสนุนที่เหมาะกับโครงการของคุณ
              ยื่นข้อเสนอออนไลน์ และติดตามสถานะได้แบบ Real-time
            </p>
            <div className="flex gap-3">
              ...
              <Button variant="outline">ดาวน์โหลดคู่มือ</Button>
            </div>
          </div>
        </div>
      </section>
