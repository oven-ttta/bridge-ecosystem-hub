        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              ติดตามและวิเคราะห์ข้อมูลระบบนิเวศ Big Data และ AI
              ของประเทศไทยแบบ Real-time
            </p>
          </div>
        </div>
      </section>
                    ...
                    <div key={region.region}>
                      <div className="flex items-center justify-between text-sm mb-2">
                        ...
                        <span className="text-muted-foreground">
                          {region.count} ราย ({region.percentage}%)
                        </span>
                      </div>
                    ...
                    <div key={cat.category}>
                      ...
                      <div className="h-3 bg-muted rounded-full overflow-hidden flex">
                        <div
                          ...
                          style={{
                            width: `${(cat.supply / cat.demand) * 100}%`,
                          }}
                        />
                        <div
                          className="h-full bg-primary/30"
                          style={{
                            width: `${100 - (cat.supply / cat.demand) * 100}%`,
                          }}
                        />
                      </div>
                      {cat.demand > cat.supply * 1.5 && (
                        <p className="text-xs text-amber-600 mt-1">
                          Gap: ต้องการผู้ให้บริการเพิ่มเติม{" "}
                          {cat.demand - cat.supply} ราย
                        </p>
                      )}
                    </div>
                  ))}
