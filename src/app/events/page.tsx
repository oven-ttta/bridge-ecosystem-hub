...
const events = [
  {
    ...
    description:
      "เรียนรู้การประยุกต์ใช้ Generative AI เพื่อเพิ่มประสิทธิภาพการดำเนินธุรกิจ พร้อม Workshop ลงมือปฏิบัติจริง",
    date: "15 ก.พ. 2568",
    time: "09:00 - 16:00",
    location: "Online",
    type: "workshop",
  ...
  },
  {
    ...
    description:
      "งานประชุมวิชาการด้าน Big Data ระดับประเทศ พบกับวิทยากรระดับโลกและนิทรรศการเทคโนโลยีล่าสุด",
    date: "22-23 ก.พ. 2568",
    time: "08:30 - 17:00",
  ...
  },
  {
    ...
    description:
      "แบ่งปันประสบการณ์และแนวปฏิบัติที่ดีในการบริหารจัดการข้อมูลองค์กร",
    date: "28 ก.พ. 2568",
    time: "14:00 - 16:00",
    location: "Hybrid",
    type: "sharing",
  ...
  },
  {
    ...
    description:
      "เรียนรู้กระบวนการ Deploy ML Model สู่ Production อย่างมืออาชีพ",
    date: "5-6 มี.ค. 2568",
    time: "09:00 - 17:00",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              เข้าร่วม Workshop, Conference และ Knowledge Sharing
              เพื่อพัฒนาศักยภาพด้าน Big Data และ AI
            </p>
          </div>
        </div>
      </section>
            ...
            {filteredEvents.map((event) => (
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <Badge
                    className={`absolute top-4 left-4 ${eventTypeConfig[event.type].bgColor} ${eventTypeConfig[event.type].textColor}`}
                  >
