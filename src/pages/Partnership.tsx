...
const Partnership = () => {
  ...
  const filteredCompanies = mockCompanies.filter((company) => {
    const matchesSearch = company.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
      company.expertise.some(e => e.toLowerCase().includes(searchQuery.toLowerCase()));
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                เชื่อมต่อกับผู้ประกอบการด้าน Big Data และ AI กว่า 500 รายในเครือข่าย BRIDGE
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <p className="text-muted-foreground">
                พบ <span className="font-semibold text-foreground">{filteredCompanies.length}</span> ผู้ประกอบการ
              </p>
            </div>
